...
def main():
    ...
    if not today_acts:
        ...
        prompt = (
            ...
            f"- Feel: 1=Very Weak, 2=Weak, 3=Normal, 4=Strong, 5=Very Strong.\n"
            f"- Effort: 1-10, где 1 очень легко, 10 максимум.\n"
            f"- ШАБЛОН СИЛОВЫХ ДНЕЙ: Chest and abs, Back and abs, Legs and abs, Shoulders, calves and abs, Arms and abs.\n"
            f"- Для этих силовых дней считай стандартный объём так: 4 упражнения на основную группу, каждое по 4 подхода по 10 повторений.\n"
            f"- Пресс: 1 упражнение, 2 подхода по 30 повторений.\n"
            f"- То есть стандартная силовая = 18 рабочих подходов и около 220 повторений за тренировку.\n"
            f"- Если Strength_Effort высокий или Strength_Feel низкий, значит этот стандартный объём дался тяжелее обычного.\n"
