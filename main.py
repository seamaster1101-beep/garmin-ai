...
try:
    ...
    try:
        ...
        for activity in activities_today:
            ...
            # Конвертируем данные (добавляем безопасное получение из Garmin API)
            ...
            # Garmin использует специфичные ключи для своих полей:
            ...
            # Округляем калории, если они есть
            if calories:
                try:
            ...
            # Создаем строку (со строгим форматом и ровно 13 колонок)
            new_row = [
                date_part,                  # 1. Date
            ...
            # value_input_option='USER_ENTERED' позволяет Google Sheets воспринимать числа с запятыми корректно
