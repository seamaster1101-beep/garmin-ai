...
# --- 1. MORNING BLOCK (надёжный вариант) ---
...
try:
    ...
    # --- 3️⃣ Weight (последнее измерение за 7 дней) ---
    for i in range(7):
    ...
    # fallback на weight из user summary
    ...
    # --- 5️⃣ HRV из последних активностей (если пусто) ---
    if not hrv:
        try:
